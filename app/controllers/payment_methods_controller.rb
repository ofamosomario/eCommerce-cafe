class PaymentMethodsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @payment_method.save
        format.html { redirect_to payment_methods_url notice: "Payment method was successfully created." }
  ...
  def update
    respond_to do |format|
      if @payment_method.update(payment_method_params)
        format.html { redirect_to payment_methods_url notice: "Payment method was successfully updated." }
  ...
  private
    ...
    def payment_method_params
      params.require(:payment_method).permit(:name, :name_value)
    end
end
